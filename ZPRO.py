...
logo = """
 ...
 \033[1;93m █▐█▀ █▀█ ▄▀▄ █▀▀ █▀▀ █░▄ █░█
  \033[1;93m▀░▀▀ ▀░▀ ▀░▀ ▀▀▀ ▀▀▀ ▀▀▀ ░▀░
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;91m Author   : RAXEELO
\033[1;93m➤\033[1;91m Github   : https://github.com/RAXEELO
\033[1;93m➤\033[1;91m Fb Id  :     RAXEELO
\033[1;97m--------------------------------------------------
"""
...
def tech_zulfiqar():
    ...
    if username =="RAXEELO":
        os.system("clear")
        print logo
        print ("[+] Username : RAXEELO (Correct)")
        ...
        if passwordss =="ESHAL":
            ...
            os.system("clear")
            print logo 
            print ("\033[1;93m[+]\033[1;91m Username : RAXEELO\033[1;91m (Correct)")
            print ("\033[1;97m[+]\033[1;91m Password : ESHAL\033[1;91m (Correct)")
	    print("\033[1;96m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open  https://www.facebook.com/SarKaR.KoHaTi.777')
            time.sleep(1)
            tech_zulfiqar()
    else:
